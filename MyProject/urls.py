...
urlpatterns = [
    ...
    path('Usuarios/', views.ListaUsuariosView.as_view(), name='ListaUsuarios'),
    path('NuevoUsuario/',views.user_register, name='crear_usuario'),
    path('Usuarios/editar/<str:pk>/', views.EditarUsuario.as_view(), name='EditarUsuario'),
    path('Usuarios/eliminar/<str:pk>/', views.EliminarUsuarioView.as_view(), name='EliminarUsuario'),
    path('Usuarios/<str:nombre>/', views.FiltroUsuario, name='UsuariosFiltrados'),
